...
plt.xlabel("Dia (d)")
plt.title("Altitud del Sol calculada") #
...
plt.axvline(365.5, color='black', linestyle='--', linewidth=2, alpha=0.5)
plt.title('Producció diària al llarg de dos anys') #
...
plt.title("Comparació: Producció simulada vs PVGIS amb Insolació simulada") # 
